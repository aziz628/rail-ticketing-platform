  ...
  return (
    <PrivateLayout navItems={navItems} user={user}>
      <div className="sncft-page-shell sncft-page-content sncft-page-section">
        ...
        <div className="sncft-tabs-admin">
          <button
            ...
            className={cn(
              'sncft-tab-admin',
              activeTab === 'agents' ? 'sncft-tab-admin-active' : 'sncft-tab-admin-inactive'
            )}
          >
          ...
          <button
            ...
            className={cn(
              'sncft-tab-admin',
              activeTab === 'controllers' ? 'sncft-tab-admin-active' : 'sncft-tab-admin-inactive'
            )}
          >
      ...
      <ConfirmationModal
        ...
        description={`Êtes-vous sûr de vouloir désactiver "${selectedStaff?.name}" ?`}
